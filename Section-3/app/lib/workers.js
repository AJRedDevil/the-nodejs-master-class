...
workers.validateCheckData = function (originalCheckData) {
  ...
  // Set the keys that may not bet set (if the workers have never seen this check before)
  ...
  if (originalCheckData.id &&
    ...
    // If check fail, log the error and fail silently.
    console.log('Error: one of he checks is not properly formatted. Skipping.');
  };
};

// Perform the check, send the originalCheck data and the outcome of the check process to the next stepin the process
