  ...
  if (userId) {
    ...
    _data.read('users', userId, function (err, userData) {
      if (!err && userData) {
        ...
        // Print their JSON object with text highlight
        cli.verticalSpace();
...
cli.processInput = function (str) {
  ...
  if (str) {
    // Codify the unique string that identify the different unique questions allowed be the asked
    const uniqueInputs = [
      'man',
      'help',
      'exit',
